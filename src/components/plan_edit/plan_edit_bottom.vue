...
<template>
    <div class="vp-bottom">
            <div class="vp-bottom-item">
                <a href="/plans" class="utils-block-link utc-light-gray">
            ...
            <div class="vp-bottom-item">
                <label for="modal-add-check" class="utils-block-link utc-light-gray">
            ...
            <div class="vp-bottom-item">
                <a href="#" class="utils-block-link utc-green">
